...
Orocos.run 'camera_calib::Task' => 'camera_calibration' do
    ...
    log_replay.camera_left.frame.connect_to(camera_calib.left_frame, :type => :buffer, :size => 100 )
    log_replay.camera_right.frame.connect_to(camera_calib.right_frame, :type => :buffer, :size => 100 )
